...
module purge
module load openmpi/4.1.4 python3/3.11.7 hdf5/1.12.2p gmsh/4.11.1 cmake

############## need input from user ####################
export GROUP=n69
export USER=tg7098
export USER_HOME=/home/565/tg7098
export ENV_NAME=uw3_boundary_integrals_h5_gadi_env
export INSTALL_NAME=uw3_boundary_integrals_h5_gadi_installs
...
install_h5py(){
		...
		CC=mpicc HDF5_MPI="ON" pip3 install --no-binary :all: --no-cache-dir h5py
}
